...
LEFT JOIN voitures_moteurs vm ON v.ID = vm.id_voiture
LEFT JOIN moteurs mo ON vm.id_moteur = mo.ID
            ...
            <div class="container">
                <div class="row justify-content-center gy-4 gy-md-0 vh-100">
                    ...
                    <div class="col-12 col-md-8 bg-light ms-md-4 voitures-container">
                        ...
                        foreach ($voituresFiltrees as $voiture) : ?>
                            <div class="car-item card mt-3 col-md-5 mx-md-1 border">
                                <img src="img/<?php echo(!empty($voiture['photos']) ? e($voiture['photos'][0]) : 'default.jpg'); ?>" 
                                     class="card-img-top shadow" 
                                     alt="<?php echo e($voiture['voiture_nom']); ?>">
                                <div class="card-body">
                                    <h5 class="card-title"><?php echo e($voiture['voiture_nom']); ?></h5>
                                    <p class="card-text"><?php echo e($voiture['description']); ?></p>
                                    <p><strong>Marque :</strong> <?php echo e($voiture['marque_nom']); ?></p>
                                    <p><strong>Date de sortie :</strong> <?php echo e($voiture['date_sortie']); ?></p>
                                    <p><strong>Moteur :</strong> <?php echo e($voiture['moteur_nom']); ?></p>
                                    <p><strong>Prix :</strong> <?php echo e($voiture['prix'] ?? '0'); ?> €</p>
                                    <a href="voiture.php?idVoiture=<?php echo (int)$voiture['voiture_id'] ?>" class="btn btn-primary">Voir plus</a>
                                </div>
                            </div>
                        <?php endforeach; ?>
                    </div>
